...
LParis 
CSE100 Session A
lparis_Assignment4.cpp
****************************************************************
*/

/*
Part 1 Answers:
Part 1.1: The output is "warning: while loop has empty body [-Wempty-body]". There should not be a semicolon after while(count < 100). Once this is fixed, numubers 5 through 104 are output.
Part 1.2: "!lwt d,duyrv a" -- Because it is a string, which is represented by ASCII number, and -2, so it shifts the characters
*/

// // Part 1.3: Beverage Menu
